...
public class JoyBio extends JFrame implements ActionListener {
    ...
    public JoyBio(ChooseMale choosemale_obj,ThreeButtons threeButtons_obj,Login login_obj) {
        super("JoyBio");
		...
		ImageIcon ic = new ImageIcon("./Recources/JoyB.png");
		l1 = new JLabel(ic);
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==visitButton)
		{
			...
			new JoyScan(this,choosemale_obj,threeButtons_obj,login_obj);
		}
