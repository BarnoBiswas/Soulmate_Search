...
public class RicheBio extends JFrame implements ActionListener {
    ...
    public RicheBio(ChooseFemale choosefemale_obj,ThreeButtons threeButtons_obj,Login login_obj) {
        super("RicheBio");
		...
		ImageIcon ic = new ImageIcon("./Recources/RicheB.png");
		l1 = new JLabel(ic);
    ...
    public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==visitButton)
		{
			...
			new RicheScan(this,choosefemale_obj,threeButtons_obj,login_obj);
		}
