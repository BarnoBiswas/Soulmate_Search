...
public class SourovBio extends JFrame implements ActionListener{
    ...
    public SourovBio(ChooseMale choosemale_obj,ThreeButtons threeButtons_obj,Login login_obj) {
        super("SourovBio");
		...
		ImageIcon ic = new ImageIcon("./Recources/SourovB.png");
		l1 = new JLabel(ic);
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==visitButton)
		{
			...
			new SourovScan(this,choosemale_obj,threeButtons_obj,login_obj);
		}
