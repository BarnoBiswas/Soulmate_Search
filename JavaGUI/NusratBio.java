...
public class NusratBio extends JFrame implements ActionListener {
    ...
    public NusratBio(ChooseFemale choosefemale_obj,ThreeButtons threeButtons_obj,Login login_obj) {
        super("NusratBio");
		...
		ImageIcon ic = new ImageIcon("./Recources/NusratB.png");
		l1 = new JLabel(ic);
    ...
    public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==visitButton)
		{
			...
			new NusratScan(this,choosefemale_obj,threeButtons_obj,login_obj);
		}
