...
public class ZakiaBio extends JFrame implements ActionListener {
    ...
    public ZakiaBio(ChooseFemale choosefemale_obj,ThreeButtons threeButtons_obj,Login login_obj) {
        super("ZakiaBio");
		...
		ImageIcon ic = new ImageIcon("./Recources/ZakiaB.png");
		l1 = new JLabel(ic);
    ...
    public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==visitButton)
		{
			...
			new ZakiaScan(this,choosefemale_obj,threeButtons_obj,login_obj);
		}
