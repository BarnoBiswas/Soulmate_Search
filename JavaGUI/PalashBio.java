...
public class PalashBio extends JFrame implements ActionListener {
    ...
    public PalashBio(ChooseMale choosemale_obj,ThreeButtons threeButtons_obj,Login login_obj) {
        super("PalashBio");
		...
		ImageIcon ic = new ImageIcon("./Recources/PalashB.png");
		l1 = new JLabel(ic);
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==visitButton)
		{
			...
			new PalashScan(this,choosemale_obj,threeButtons_obj,login_obj);
		}
