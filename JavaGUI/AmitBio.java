...
public class AmitBio extends JFrame implements ActionListener {
    ...
    public AmitBio(ChooseMale choosemale_obj,ThreeButtons threeButtons_obj,Login login_obj) {
        super("AmitBio");
		...
		ImageIcon ic = new ImageIcon("./Recources/AmitB.png");
		l1 = new JLabel(ic);
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==visitButton)
		{
			...
			new AmitScan(this,choosemale_obj,threeButtons_obj,login_obj);
		}
