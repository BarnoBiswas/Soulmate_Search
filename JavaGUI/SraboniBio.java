...
public class SraboniBio extends JFrame implements ActionListener {
    ...
    public SraboniBio(ChooseFemale choosefemale_obj,ThreeButtons threeButtons_obj,Login login_obj) {
        super("SraboniBio");
		...
		ImageIcon ic = new ImageIcon("./Recources/SraboniB.png");
		l1 = new JLabel(ic);
    ...
    public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==visitButton)
		{
			...
			new SraboniScan(this,choosefemale_obj,threeButtons_obj,login_obj);
		}
